...
export class EventsService {
    ...
    updateEvent(eventToUpdate: IEvent) {
        const event = events.find(event => event.id === eventToUpdate.id);
        Object.assign(event, eventToUpdate);
    }
    findSessions(query: string) {
...
const events: IEvent[] = [
    {
        ...
        time: '10:00 am',
        price: 599.99,
        imageUrl: 'src/app/assets/images/angularconnect-shield.png',
        location: {
        address: '1057 DT',
        city: 'London',
        country: 'England'
    ...
    },
    {
        ...
        time: '9:00 am',
        price: 950.00,
        imageUrl: 'src/app/assets/images/ng-nl.png',
    ...
    },
    {
        ...
        time: '9:00 am',
        price: 759.00,
        imageUrl: 'src/app/assets/images/ng-conf.png',
        location: {
    ...
    },
    {
        ...
        time: '8:00 am',
        price: 800.00,
        imageUrl: 'src/app/assets/images/basic-shield.png',
        location: {
    ...
    },
    {
        ...
        time: '9:00 am',
        price: 400.00,
        imageUrl: 'src/app/assets/images/ng-vegas.png',
        location: {
